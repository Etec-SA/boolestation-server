...
describe("UsersController", () => {
  ...
  describe("update", () => {
    it("should update an user with success", async () => {
      ...
      const response = await controller.update(update, {
        user: { id: "some-id" },
  ...
  describe("delete", () => {
    it("should remove an existing user", async () => {
      ...
      jest
        ...
        .mockResolvedValueOnce(existingUserId as any);
    ...
    it("should throw an error if the user to remove does not exist", async () => {
      ...
      await expect(controller.remove(nonExistingUserId)).rejects.toThrowError(
        "user not found"
      );
