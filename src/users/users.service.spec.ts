...
describe("UsersService", () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: LevelStatesService, useValue: levelStateServiceMock },
        {
          ...
          useValue: profilePicturesServiceMock,
        },
      ],
    }).compile();
  ...
  describe("update", () => {
    it("should update an user with success", async () => {
      jest
        .spyOn(service, "verifyUniqueProperty")
  ...
  describe("findByEmail", () => {
    ...
    it("should throw an error", async () => {
      ...
      await expect(
        service.findByEmail("user@email.com")
  ...
  describe("remove", () => {
    it("should remove an existing user", async () => {
      ...
      jest
        ...
        .mockResolvedValueOnce({ id: existingUserId } as any);
    ...
    it("should throw an error if the user to remove does not exist", async () => {
      ...
      await expect(service.remove(nonExistingUserId)).rejects.toThrowError(
